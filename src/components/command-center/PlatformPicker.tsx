...
export function PlatformPicker({ value, onChange, cascade: _cascade, onCascadeChange: _onCascadeChange, showCascade: _showCascade, enabledPlatforms }: PlatformPickerProps) {
  const { t } = useLanguage()
