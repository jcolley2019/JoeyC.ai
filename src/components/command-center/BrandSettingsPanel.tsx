      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#1e2a4a]">
          <div>
            ...
            <h2 id="brand-settings-title" className="text-lg font-semibold text-white mt-0.5">Brand Settings</h2>
          </div>
          <button onClick={onClose} aria-label="Close" className="text-[#8892a4] hover:text-white transition-colors p-1">
