...
/**
 * Sandbox page — a copy of the Hero section for experimenting
 * with layout, text, and image changes without touching the live site.
 * Visit /sandbox to use it.
 */
...
export function Sandbox() {
  ...
  return (
    <div className="min-h-screen bg-bg noise-overlay" style={{ overflowX: 'hidden', maxWidth: '100vw' }}>
      ...
      {/* Sandbox banner */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-yellow-500/90 text-black text-center text-xs font-bold py-1 tracking-widest" style={{ fontFamily: "'Rajdhani', sans-serif" }}>
        SANDBOX — changes here don't affect the live site
      </div>
                ...
                <div className="flex items-center justify-evenly w-full px-2" style={{ marginTop: 'clamp(6px, 0.8vw, 12px)', fontFamily: "'Rajdhani', sans-serif" }}>
                  ...
                  <a href="https://instagram.com/gobuildai" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white hover:text-pink-500 transition-colors" style={{ fontSize: 'clamp(11px, 1.3vw, 18px)', fontWeight: 600 }}>
                    <svg viewBox="0 0 448 512" style={{ width: 'clamp(14px, 1.5vw, 20px)', height: 'clamp(14px, 1.5vw, 20px)' }}>
                      <defs>
                        <linearGradient id="ig-grad-sandbox" x1="0%" y1="100%" x2="100%" y2="0%">
                          <stop offset="0%" stopColor="#fd5949" />
                          <stop offset="50%" stopColor="#d6249f" />
                          <stop offset="100%" stopColor="#285AEB" />
                        </linearGradient>
                      </defs>
                      <path fill="url(#ig-grad-sandbox)" d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/>
                    </svg>
                    @gobuildai
                  </a>
                </div>
